                    ...
                    <div className="row">
                        <div className="col-md-4 login-sec">
                            ...
                            <Form method="post" name="userRegistrationForm" onSubmit={this.submitUserRegistrationForm}>
                                <FormGroup>
                                    <Input type="text" name="email" id="exampleEmail" value={this.state.username}
                                           onChange={this.handleChangeEmail} placeholder="&#xf0e0; Email Id"/>
                                ...
                                <FormGroup check>
                                    <Label check>
                                        <Input type="checkbox" value={this.state.rememberMe}
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="d-flex justify-content-center links">
                                        ...
                                        Don't have an account? <Link href="/register" to="/register"
                                                                     className="linka">Register</Link>

...
export default class ViewSingleBill extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div >
                ...
                <Link to='/listBills'><button className="btn-back" >Back</button></Link>
                <div id="pdfdiv" >
                    ...
                    <div className="card col-md-6 offset-md-3" >
                        ...
                        <div className="card-body">
                            ...
                            <table className="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    <td><b>Due Date:</b> </td>
                                    <td>{this.dateFormatHandler(this.state.bill.endDate)}</td>
                                    <td>{parseFloat(this.state.bill.totalCharge).toFixed(2)}</td>
                                </tr>
                                <tr>
                                    <td><b>If Paid by this Date:</b></td>
                                    <td>{this.dateFormatHandler(this.state.bill.startDate)}</td>
                                    <td>{parseFloat(this.state.bill.totalCharge).toFixed(2)}</td>
                                </tr>
                                <tr>
                    ...
                    <p className="text-sm" >*For queries related to your online payment transactions, please contact <u>eletricitysystem2021@gmail.com </u></p>
                    <p className="text-sm" > Any unauthorized changes made in the bills will lead to non-acceptance of the bill</p>
                </div>
            </div>
